...
void initialise_cube(struct Point points[], int num){
  ...
  // side 3
  for (int i = 0; i < p_side; i++) {
    points[i + 2 * p_side] = (struct Point){-side_length / 2,
                                            -side_length / 2 + i * step_size,
                                            +side_length / 2};
  }
  // side 4
  for (int i = 0; i < p_side; i++) {
    points[i + 3 * p_side] = (struct Point){+side_length / 2,
                                            -side_length / 2 + i * step_size,
                                            +side_length / 2};
  }
  //
  ...
  // side 7
  for (int i = 0; i < p_side; i++) {
    points[i + 6 * p_side] = (struct Point){-side_length / 2,
                                            -side_length / 2 + i * step_size,
                                            -side_length / 2};
  }
  // side 8
  for (int i = 0; i < p_side; i++) {
    points[i + 7 * p_side] = (struct Point){+side_length / 2,
                                            -side_length / 2 + i * step_size,
                                            -side_length / 2};
  }
  // side 9
  for (int i = 0; i < p_side; i++) {
    points[i + 8 * p_side] = (struct Point){-side_length / 2,
                                            -side_length / 2,
                                            -side_length / 2 + i*step_size};
  }
  // side 10
  for (int i = 0; i < p_side; i++) {
    points[i + 9 * p_side] = (struct Point){side_length / 2,
                                            -side_length / 2,
                                            -side_length / 2 + i * step_size};
  }
  // side 11
  for (int i = 0; i < p_side; i++) {
    points[i + 10 * p_side] = (struct Point){side_length / 2,
                                             side_length / 2 ,
                                             -side_length / 2 + i * step_size};
  }
  // side 12
  for (int i = 0; i < p_side; i++) {
    points[i + 11 * p_side] = (struct Point){-side_length / 2,
                                              side_length / 2,
                                              -side_length / 2 + i * step_size};
  }
}
...
int main() {
  ...
  while (is_running) {
    ...
    SDL_FillRect(surface, &black_rect, COLOUR_BLACK);
    for (int i = 0; i < num; i++)
